/** @file Controller_MultiFinger.h
 * 	@brief Contains methods for controlling the motors and parsing input
 * 	This version of the class is written assuming that each finger joint can be controller
 * 	At the moment this code is completely theoretical, and testing is not possible.
 *
 */

#ifndef CONTROLLER_MULTIFINGER_H_
#define CONTROLLER_MULTIFINGER_H_
...
public:
	...
	typedef struct arm_command {
		Controller_MultiFinger::Arm_Operation op; /**< The operation used in the command Structure */
